    ...
    <div className="jf-flex jf-flex-col jf-gap-2">
      <div className="jf-flex jf-flex-wrap jf-items-center jf-gap-2">
        <button
          ...
          className="jf-inline-flex jf-border-none jf-items-center jf-gap-2 jf-rounded-md jf-bg-primary-600 jf-px-5 jf-py-2 jf-text-base jf-font-bold jf-text-on-primary jf-shadow-sm jf-transition-all jf-duration-200 hover:jf-bg-primary-700 hover:jf-shadow-md hover:-jf-translate-y-0.5 disabled:jf-opacity-60"
        >
          {status === "loading"
            ? "Generating…"
            : letter
